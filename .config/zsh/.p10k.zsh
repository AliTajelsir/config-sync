# Generated by Powerlevel10k configuration wizard on 2020-07-24 at 20:11 CAT.
...
() {
  ...
  function my_git_formatter() {
    ...
    if (( $1 )); then
      ...
      local      clean='%129F'  # purple foreground
  ...
  # Icon color.
  typeset -g POWERLEVEL9K_VCS_VISUAL_IDENTIFIER_COLOR=129
